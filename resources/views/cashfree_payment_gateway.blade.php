...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-7 pb-5" style="margin-top: 2%;">
            <!--Form with header-->
            <form role="form" action="{{ url('order-post') }}" method="post">
                @csrf
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customerName"
                                        placeholder="Customer Name" value="{{ Auth::User()->name }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customerPhone"
                                        placeholder="Customer Name" value="{{ Auth::User()->phone }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customerEmail"
                                        placeholder="Customer Name" value="{{ Auth::User()->email }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="amount" placeholder="Amount"
                                        value="{{ Session::get('GrandTotal') }}" readonly>
