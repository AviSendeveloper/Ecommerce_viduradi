...
<html lang="en" dir="ltr">
   ...
   <body>
							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="https://ecom.viduradi.com/admin/commission/earning">Commission Earning</a>
											</li>
										</ul>
								</div>
							</div>
						</div>
						<form action="https://ecom.viduradi.com/admin/commission/earning" method="GET">
										...
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													...
													<tbody>
																...
																<td>1</td>
																<td>
																	<a  href="https://ecom.viduradi.com/admin/order/128/invoice">
																		1622530128
																	</a>
																</td>
																<td>
	...
	$('.discount_date').val('');
	location.href = 'https://ecom.viduradi.com/admin/commission/earning';
	})												
</script>
