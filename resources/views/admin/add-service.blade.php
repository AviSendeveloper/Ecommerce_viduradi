            ...
            <div class="wrapper">
                ...
                <div class="content-area">
                    <div class="mr-breadcrumb">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 class="heading">Add Services <a class="add-btn" href="/admin-service"><i
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <select class="input-field" name="category" required="" >
                                                        ...
                                                        <option value="100% Secure Payment">100% Secure Payment</option>
                                                        <option value="Shipping Partners">Shipping Partners</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                    <div class="img-upload full-width-img">
                                                        <div id="image-preview" class="img-preview"
                                                            style="background: url(assets/admin/images/upload.png);">
