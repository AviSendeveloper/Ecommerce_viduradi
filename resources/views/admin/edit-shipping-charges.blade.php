                        ...
                        <div class="col-lg-12">
                           <div class="product-description">
                              <div class="body-area">
                                 ...
                                 <form action="/update-charges" method="POST">
                                  @csrf
                                  <input type="hidden" name="id" value="{{$data['id']}}">
                                    ...
                                    <div class="row justify-content-center">
                                       <div class="col-lg-3">
                                          <div class="left-area">
                                             <h4 class="heading">Country Name *
                                             </h4>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <input type="text" class="input-field" placeholder="brand Name" name="country" value="{{$data['country']}}"  required="">
                                       </div>
                                    </div>
                                    <div class="row justify-content-center">
                                       <div class="col-lg-3">
                                          <div class="left-area">
                                             <h4 class="heading">Shipping Charges *
                                             </h4>
                                          </div>
                                       </div>
                                       <div class="col-lg-6">
                                          <input type="text" class="input-field" placeholder="brand Name" name="shipping_charges"value="{{$data['shipping_charges']}}"  required="">
                                       </div>
                                    </div>
