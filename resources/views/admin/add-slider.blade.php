		...
		<div class="page">
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">Add Slider <a class="add-btn" href="/admin-slider"><i class="fas fa-arrow-left"></i> Back</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="admin/slider/create">Edit Slider</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form action="/add-slider-home-page" method="POST" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="alert alert-success validation" style="display: none;">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="slug" placeholder="Link" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="caption" placeholder="Caption(optional)" required="" value="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
