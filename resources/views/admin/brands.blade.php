                          ...
                          @endif
                           <div class="mr-table allproduct">
                              ...
                              <div class="col-sm-4 table-contents" style="float: right;">
                                <a class="add-btn" href="/add-edit-brand">
                                    <i class="fas fa-plus"></i> <span class="remove-mobile">Add New brands<span>
                                </a>
                               </div>
                                    ...
                                    <tbody>
                                        @foreach ($brand as $brands)
                                            <tr>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                    <input data-id="{{$brands['id']}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-style="ios" data-on="Active" data-off="InActive" {{ $brands['status'] ? 'checked' : '' }}>
                                                    <span class="slider round"></span>
                                                    </label>
                                                </td>
                                                <td>
                                                    <a href="/add-edit-brand/{{$brands['id']}}"><i class="fas fa-edit"></i></a>
                                                    <a href="/delete-brands/{{$brands['id']}}"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
     ...
     <!--  <script type="text/javascript">
      ...
      $(function() {
        $('.toggle-class').change(function() {
            ...
            var brands_id = $(this).data('id');
            //  alert(user_id);
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '/change-brands-status',
