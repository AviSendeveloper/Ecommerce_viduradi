                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form action="/edit-role-submit" method="POST" enctype="multipart/form-data">
                       @csrf
            ...
            <ul class="text-left">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-10">
                            ...
                            <select class="input-field" name="email" placeholder="email" required="">
                         ...
                         <div class="row">
                          <div class="col-lg-2">
                            <div class="left-area">
                                <h4 class="heading">User Type *</h4>
                                <p class="sub-heading">(If you want to make Main Admin write 'admin' )</p>
                            </div>
                          </div>
                          <div class="col-lg-10">
                           
                            <input class="input-field" name="user_type" value="{{ $data->user_type }}" placeholder="admin" >
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="orders" value="1" @if($data->orders == 1)checked="" @else  @endif>
                            ...
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="products" value="1" @if($data->products == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="customers" value="1" @if($data->customers == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="categories" value="1" @if($data->categories == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="bulk_product_upload" value="1" @if($data->bulk_product_upload == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="set_coupons" value="1" @if($data->set_coupons == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="blog" value="1" @if($data->blog == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="messages" value="1"@if($data->messages == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="general_settings" value="1" @if($data->general_settings == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="payment_settings" value="1" @if($data->payment_settings == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="manage_staffs" value="1"  @if($data->manage_staffs == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                            <div class="col-lg-2"></div>
                            <div class="col-lg-4 d-flex justify-content-between">
                              ...
                              <label class="switch">
                                <input type="checkbox" name="subscribers" value="1" @if($data->subscribers == 1)checked="" @else  @endif>
                                <span class="slider round"></span>
                              </label>
                            </div>
                        </div>
