   ...
   <body>
							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="https://ecom.viduradi.com/admin/withdraw/earning">Withdraw Earning</a>
											</li>
										</ul>
								</div>
							</div>
						</div>
						<form action="https://ecom.viduradi.com/admin/withdraw/earning" method="GET">
      ...
      <button type="button" class="close alert-close"><span>×</span></button>
            <ul class="text-left">
								...
								<div class="col-lg-12">
								  <p class="text-center"> <b>     Total Earning : Rs.6.5</b></p>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														...
														<tr>
									                        ...
									                        <th width="20%">Withdraw Earning</th>
	...
	$('.discount_date').val('');
	location.href = 'https://ecom.viduradi.com/admin/withdraw/earning';
	})												
</script>
