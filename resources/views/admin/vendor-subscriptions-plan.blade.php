              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="https://ecom.viduradi.com/admin/subscription">Vendor Subscription Plans</a>
                      </li>
                    </ul>
                </div>
              </div>
            ...
            <p class="text-left"></p> 
                    ...
                    <div class="modal-content">
                        <div class="submit-loader">
                            <img  src="https://ecom.viduradi.com/assets/images/spinner.gif" alt="">
                        </div>
  ...
  <div class="modal-header d-block text-center">
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: 'https://ecom.viduradi.com/admin/subscription/datatables',
               columns: [
                ...
                language : {
                  processing: '<img src="https://ecom.viduradi.com/assets/images/spinner.gif">'
                }
            });

        $(function() {
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="https://ecom.viduradi.com/admin/subscription/create" id="add-data" data-toggle="modal" data-target="#modal1">'+
