                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form action="/edit-slider-home-page" method="POST" enctype="multipart/form-data">
                        @csrf
                      ...
                      <div class="alert alert-success validation" style="display: none;">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" value="{{$data['slug']}}" name="slug" placeholder="Link" required="" value="">
                          </div>
                        </div>
                         <div class="row">
                          <div class="col-lg-4">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" value="{{$data['caption']}}" name="caption" placeholder="Caption(optional)">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-4">
