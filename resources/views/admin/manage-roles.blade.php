   ...
   <body>
      ...
      <button type="button" class="close alert-close"><span>×</span></button>
        ...
        <?php use App\Models\admin; ?>
                        ...
                        <a class="add-btn" href="/add-new-role">
                        ...
                        <table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                                          ...
                                          <th>Customers</th>
                                          <th>Brand</th>
                                          <th width="50%">Bulk Product Upload</th>
                                          <th>Set coupons</th>
                                          <th>Blog</th>
                          ...
                          @foreach($allAdmin as $admin)
                            <tr>
                              ...
                              <td>{{$admin['bulk_product_upload']}}</td>
                              <td>{{$admin['set_coupons']}}</td>
                              <td>{{$admin['blog']}}</td>
                              <td>{{$admin['messages']}}</td>
                              <td>{{$admin['general_settings']}}</td>
                              <td>{{$admin['payment_settings']}}</td>
                              <td>{{$admin['subscribers']}}</td>
                              <td>{{$admin['manage_staffs']}}</td>
                              <td><a href="/edit-role/{{$admin['id']}}"><i class="fas fa-edit"></i></a>&nbsp;
                                  <a href="/delete-role/{{$admin['id']}}"><i class="fas fa-trash"></i></a>
                              </td>
                            </tr>
                            @endforeach
                          </tbody>
  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block">Confirm Delete</h4>
      ...
      <div class="modal-body">
            <p class="text-center">You are about to delete this Role.</p>
