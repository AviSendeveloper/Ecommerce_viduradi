         ...
         <div class="page-main">
            ...
            <div class="wrapper">
               ...
               @include('layout.nav')
					...
					<input type="hidden" id="headerdata" value="REPORT">
								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks drop-success">
	                                      <option data-val="1" value="/admin/general-settings/report/1" selected>Activated</option>
	                                      <option data-val="0" value="/admin/general-settings/report/0" >Deactivated</option>
	                                    </select>
	                                  </div>
								</div>
...
<div class="modal fade" id="confirm-delete">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">You are about to delete this Report.</p>
