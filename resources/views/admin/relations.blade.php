            ...
            <div class="wrapper">
               ...
               @include('layout.nav')
					<!-- Main Content Area Start -->
										<input type="hidden" id="headerdata" value="RELATION">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">Cross Selling Relations</h4>
										<ul class="links">
											<li>
												<a href="/admin">Dashboard </a>
											</li>
											<li><a href="javascript:;">Cross Selling Relations</a></li>
										</ul>
								</div>
							</div>
						</div>
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '/admin/csrelation/datatables',
               columns: [
      	...
      	$(function() {
			$(".btn-area").append('<div class="col-sm-4 table-contents">'+
				'<a class="add-btn" href="/admin/csrelation/create">'+
