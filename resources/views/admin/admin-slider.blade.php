                        ...
                        @endif
                                  ...
                                  <button type="button" class="close alert-close"><span>×</span></button>
                                    ...
                                    <div class="col-sm-4 table-contents" style="float: right;">
                                     <a class="add-btn" href="/add-slider">
                                      <i class="fas fa-plus"></i> <span class="remove-mobile">Add New Slider<span>
                                       </a>
                                       </div>
										<div class="table-responsiv">
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{asset('slider/image')}}/{{$sliders['image']}}"></td>
                                                            <td>{{$sliders['slug']}}</td>
                                                            <td>{{$sliders['caption']}}</td>
                                                            <td><a href="/edit-slider/{{$sliders['id']}}"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                                                                <a href="/delete-banner/{{$sliders['id']}}"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  ...
  <!--   <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="admin/slider/create">'+
