                     ...
                     <div class="row">
                        ...
                        @endif
                           <div class="mr-table allproduct">
                             ...
                             <a class="add-btn" href="/add-edit-category">
                              <i class="fas fa-plus"></i> <span class="remove-mobile">Add New Category<span>
                               </a>
                               </div>
                                    ...
                                    @foreach($categories as $category)
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <td>
                                             <a href="{{ url('/add-edit-category/'.$category['id']) }}"><i class="fa fa-edit"></i></a>
                                             <a href="{{ url('/delete-category/'.$category['id'].'?') }}"><i class="fa fa-trash"></i></a>
                                          </td>
                                      </tr>
                                      @endforeach
                                    </tbody>
