                            ...
                            <div class="col-lg-12">
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <form action="/edit-special-discount" method="POST">
                                            @csrf
                                            <input type="hidden" name="special_discount_id" value="{{ $specialDiscount['id'] }}">
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <div class="left-area">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="input-field" name="minimum_price"
                                                        placeholder="Minimum Price" required="" value="{{ $specialDiscount['minimum_price'] }}">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-2">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="input-field" name="discount"
                                                        placeholder="Discount" required="" value="{{ $specialDiscount['discount'] }}">
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-4 d-flex justify-content-between">
                                                    ...
                                                    <label class="switch">
                                                        <input type="checkbox" name="status" @if ($specialDiscount['status'] == 1) value="1" checked @else value="0" @endif>
