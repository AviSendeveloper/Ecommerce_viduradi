            ...
            <div class="wrapper">
                ...
                <div class="content-area">
                    <div class="mr-breadcrumb">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 class="heading">All Gateways</h4>
                                <ul class="links">
                                    <li>
                                    ...
                                    <li>
                                        <a href="payment-getway-setting">All Gateways</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($getways as $getway)
                                                    <tr>
                                                        <td>{{ $getway['id'] }}</td>
                                                        <td>{{ $getway['name'] }}</td>
                                                        <td>{{ $getway['description'] }}</td>
                                                        <td><input data-id="{{$getway['id']}}" class="toggle-class" type="checkbox" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-style="ios" data-on="Active" data-off="InActive" {{$getway['status'] ? 'checked' : '' }}></td>
                                                        <td>
                                                            <a href="/edit-payment-getway/{{ $getway['payment_table_name'] }}/{{ $getway['id'] }}"><i class="fas fa-edit"></i></a>
                                                            <a href="/payment-getway-delete/{{ $getway['payment_table_name'] }}/{{ $getway['id'] }}"><i class="fas fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
          ...
          $('.toggle-class').change(function() {
            ...
            //   alert(gatway_id);
              ...
              $.ajax({
                  ...
                  dataType: "json",
                  url: '/change-status',
                  data: {'status': status, 'gatway_id': gatway_id},
