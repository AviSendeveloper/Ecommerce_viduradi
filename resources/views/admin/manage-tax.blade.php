                                            ...
                                            <tbody>
                                                @foreach ($taxes as $tax)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/edit-tax/{{ $tax['id'] }}"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <a href="/delete-tax/{{ $tax['id'] }}"><i
