							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="https://ecom.viduradi.com/admin/category">Main Categories</a>
											</li>
										</ul>
								</div>
							</div>
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: 'https://ecom.viduradi.com/admin/category/datatables',
               columns: [
                        { data: 'name', name: 'name' },
												{ data: 'slug', name: 'slug' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="https://ecom.viduradi.com/admin/category/create" id="add-data" data-toggle="modal" data-target="#modal1">'+
