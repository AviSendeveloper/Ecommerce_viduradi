            ...
            <div class="wrapper">
               ...
               <div class="content-area">
                  <div class="mr-breadcrumb">
                     <div class="row">
                        <div class="col-lg-12">
                           <h4 class="heading">Customer Default Image </h4>
                           <ul class="links">
                              <li>
                        ...
                        @endif
                           ...
                           <div class="product-description">
                              <div class="body-area">
                                 ...
                                 <form action="/add-dp" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                       <div class="col-lg-4">
                                          <div class="left-area">
                                             <h4 class="heading"> Customer Image *</h4>
                                       ...
                                       <div class="col-lg-7">
                                          <div class="img-upload">
                                             <div id="image-preview" class="img-preview" style="background: url(assets/images/1567655174profile.jpg);">
                                                <label for="image-upload" class="img-label" id="image-label"><i class="icofont-upload-alt"></i>Upload Image</label>
                                                <input type="file" name="dp" class="img-upload" id="image-upload">
                                             </div>
                                          </div>
                                       </div>
                                    </div>
