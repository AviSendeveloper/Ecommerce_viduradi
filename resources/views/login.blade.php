...
<body>
    ...
    <div class="container">
        ...
        <form class="well form-horizontal" action="/login-submit" method="post" id="contact_form">
            @csrf
            <fieldset>
    ...
    cursor: pointer;">
                ...
                <div class="row">
                    <div class="col-md-5 control-label">
                        <input name="Remember" value="1" type="checkbox" id="checkbox1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 control-label">
                        <p>If you are new user?<a href="/register">Go register page</a> </p>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4" style="text-align: center;"><br>
                      <button type="submit"
                            class="btn btn-warning">SUBMIT <span
