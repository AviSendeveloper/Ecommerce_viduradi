        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="XdpTC- _2GyCkX">
                            <div><span>Order placed for </span>₹169!</div>
                        </div>
                        <div><span>Your 1 item will be delivered by </span><span class="_2GyCkX">Sat, Jan 8th
                                '22</span>.</div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="_3Tm5aQ">Why call? Just click!</div>
                        <div class="_33YwuI">Easily track all your Flipkart orders!</div>
                        <a class="_3J-yfZ" href="#">Go to My Orders</a>
                    </div>
                    <div class="col-md-1 col-lg-1 col-sm-12">
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div>
                            ...
                            <div class="_3LuzG3">
                                <div class="_1XnLtY">
                                    <div class="_3N-YiT">Priyanka</div>
                                </div>
                                <div class="_104tHa">priya@yopmail.com</div>
                                <div class="_1QP4w_">Mary vdfvfv hghnghn Thfthtgh, fdgvv, P.O. gvbhgb, gffgbfb -
                                    343434, West Bengal</div>
                                <div class="_1XnLtY _2u8s7u">
                                    <div><span class="_3N-YiT">Phone number</span>
                                        <div class="_1egRWs">99999999</div>
                                    </div>
                                </div>
                                <br>
                                <span class="_2K1cxl">This order is also tracked by 999999999</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        ...
                        <div class="_2kcozy">
                            <div>2 SuperCoins</div>
                            <div class="-gBnNp">Will be credited after return period is over</div>
                        </div>
                    </div>
            ...
            <div class="vhguyh">
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="GYYyEN">
                            <div class="_1t3MJ7">₹169</div>
                            <div class="sre3w"><span class="_3vvH_e">1 Offer Applied</span>
                                <div class="Bv11UC"><span class="question">?</span></div>
                            </div>
                        </div>
                        <br>
                        <span class="_2LAzKy"><img
                                src="user/assets/images/rong.svg"
                                class="_1dki8b "> <span class="_2YpB-X">Cancel</span></span>
                                <br>
                                <br>
                                <span class="_2LAzKy"><img
                                src="user/assets/images/contactusIcon.svg"
                                class="_1dki8b "> <span class="_2YpB-X">Need help?</span></span>
                    </div>
                </div>
